        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mt-8 bg-white overflow-hidden shadow-sm sm:rounded-2xl p-6 md:p-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
                    <a href="{{ route('admin.kategori') }}" class="flex items-center gap-4 p-4 border border-gray-100 rounded-xl hover:bg-gray-50 hover:border-blue-200 transition-all group">
                    ...
                    <a href="{{ route('admin.pengguna') }}" class="flex items-center gap-4 p-4 border border-gray-100 rounded-xl hover:bg-gray-50 hover:border-blue-200 transition-all group">
                    ...
                    <a href="{{ route('admin.verifikasi.kegiatan') }}" class="flex items-center gap-4 p-4 border border-gray-100 rounded-xl hover:bg-gray-50 hover:border-blue-200 transition-all group">
