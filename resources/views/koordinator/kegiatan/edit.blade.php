<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <!-- Back to Kegiatan List -->
            <div class="mb-6">
                <a href="{{ route('koordinator.kegiatan.index') }}" class="inline-flex items-center text-sm font-semibold text-gray-600 hover:text-[#4379F2] transition-colors">
