<x-app-layout>
    ...
    <x-slot name="header">
        <div class="flex items-center gap-4">
            <div class="w-10 h-10 bg-[#6ef3d6]/10 text-[#6ef3d6] rounded-xl flex items-center justify-center">
                ...
                <form action="{{ route('koordinator.kegiatan.store') }}" method="POST" enctype="multipart/form-data" class="p-8 space-y-8">
                    ...
                    <div class="bg-gray-50/50 p-6 rounded-2xl border border-gray-100/50">
                        ...
                        <input type="text" id="judul_kegiatan" name="judul_kegiatan" value="{{ old('judul_kegiatan') }}" 
                            class="input-premium w-full px-5 py-3.5 bg-white border rounded-xl focus:outline-none focus:ring-2 focus:ring-[#0ecedb]/20 focus:border-[#0ecedb] text-gray-800 text-lg font-semibold placeholder-gray-300 @error('judul_kegiatan') border-rose-400 @else border-gray-200 @enderror"
                        ...
                        <div class="bg-gray-50/50 p-6 rounded-2xl border border-gray-100/50">
                            ...
                            <div class="relative">
                                <input type="number" id="kuota_relawan" name="kuota_relawan" value="{{ old('kuota_relawan') }}" min="1"
                                    class="input-premium w-full pl-5 pr-16 py-3.5 bg-white border rounded-xl focus:outline-none focus:ring-2 focus:ring-[#0ecedb]/20 focus:border-[#0ecedb] text-gray-800 font-semibold @error('kuota_relawan') border-rose-400 @else border-gray-200 @enderror"
                    ...
                    <div class="bg-gray-50/50 p-6 rounded-2xl border border-gray-100/50">
                        ...
                        <textarea id="deskripsi" name="deskripsi" rows="6"
                            class="input-premium w-full px-5 py-4 bg-white border rounded-xl focus:outline-none focus:ring-2 focus:ring-[#0ecedb]/20 focus:border-[#0ecedb] text-gray-700 leading-relaxed placeholder-gray-300 @error('deskripsi') border-rose-400 @else border-gray-200 @enderror"
                    ...
                    <div class="bg-blue-50/30 p-6 rounded-2xl border border-blue-100/50">
                        ...
                        <div class="relative border-2 border-dashed border-blue-200 rounded-2xl bg-white p-8 text-center hover:bg-blue-50/50 transition-colors cursor-pointer group">
                            ...
                            <div class="flex flex-col items-center pointer-events-none">
                                <div class="w-16 h-16 bg-blue-100 text-[#0ecedb] rounded-full flex items-center justify-center mb-3 group-hover:scale-110 transition-transform">
                    ...
                    <div class="flex items-center justify-end gap-4 pt-4 border-t border-gray-100">
                        ...
                        <button type="submit" class="px-10 py-3.5 bg-gradient-to-r from-[#6ef3d6] to-emerald-600 text-white text-sm font-bold rounded-xl shadow-lg shadow-emerald-500/30 hover:shadow-emerald-500/50 hover:-translate-y-0.5 transition-all duration-300">
