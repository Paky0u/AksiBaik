                                    ...
                                    <div x-show="expanded" x-collapse x-cloak>
                                        <div class="border-t border-gray-100 bg-gray-50/50 p-6">
                                            <div class="mb-4 flex justify-end">
                                                <a href="{{ route('koordinator.donasi.export', $kegiatan->id_kegiatan) }}" class="inline-flex items-center gap-2 px-4 py-2 bg-white border border-gray-200 text-sm font-bold text-gray-700 hover:text-[#0ecedb] hover:border-[#0ecedb] rounded-lg shadow-sm transition-colors">
